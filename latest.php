...
<body>
        ...
        <div class="swiper-wrapper shoppingPosterWrapper">
            <div class="swiper-slide shoppingPosterSlide">
                <div class="leftSlide">
                    ...
                    <button href="#" class="btn btn1 btnServ"><a href="#">Commencez votre shopping</a></button>
                </div>
            ...
            <div class="swiper-slide shoppingPosterSlide">
                <div class="leftSlide">
                    ...
                    <button class="btn btn1 btnServ"><a href="#">Commencez votre shopping</a></button>
                    <a href="don.php" class="btn btn1 btnServ">Aidez d'autres!</a>
                </div>
                <div class="rightSlide">
    ...
    <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <script src="js/shopping2.js"></script>
</body>
